...
e.g: Administrators, Developers, Auditors
...
1. A user can belong to a group. Roles can be applied to groups to quickly add and remove permissions en-masse to users.
2. A user can have a role directly attached.
An policy can be directly attached to a user(called an Inline Policy)
3. Roles can have many policies attached. 
4. Various AWS resources allow you attach roles directly to them.
