<!-- TOC -->
  ...
  * [KMS - Multi Region Keys](#kms---multi-region-keys)
    * [DynamoDB Global Tables and KMS Multi-Region Keys Client-side encryption](#dynamodb-global-tables-and-kms-multi-region-keys-client-side-encryption)
  * [S3 Replication and Encryption Consideration](#s3-replication-and-encryption-consideration)
  ...
  * [SSM Parameter Store Overview](#ssm-parameter-store-overview)
    ...
    * [Parameter Policies(for advanced parameters)](#parameter-policiesfor-advanced-parameters)
      * [Expiration(to delete a parameter)](#expirationto-delete-a-parameter)
  ...
  * [AWS Certificate Manager(ACM)](#aws-certificate-manageracm)
    * [ACM - Requesting Public Certificates](#acm---requesting-public-certificates)
    * [ACM - Importing Public Certificates](#acm---importing-public-certificates)
  ...
  * [AWS WAF - Web Application Firewall](#aws-waf---web-application-firewall)
    * [WAF - Fixed IP while using WAF with a Load Balancer](#waf---fixed-ip-while-using-waf-with-a-load-balancer)
  * [Shield - DDoS Protection](#shield---ddos-protection)
  ...
  * [AWS Best Practices for DDoS Resiliency](#aws-best-practices-for-ddos-resiliency)
    * [Edge Location Mitigation(BP1, BP3)](#edge-location-mitigationbp1-bp3)
    * [Best practices for DDoS Mitigation](#best-practices-for-ddos-mitigation)
