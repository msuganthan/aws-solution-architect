...
#### Partition: Spread instances across many different partitions (which rely on different sets of racks) within a AZ. Scales to 100s of EC2 instances per group (Hadoop, Casandra, Kafka)
